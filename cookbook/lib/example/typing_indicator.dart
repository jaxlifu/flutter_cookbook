...
class _ExampleIsTypingState extends State<ExampleIsTyping> {
  ...
  Widget _buildBody() {
    return Column(
      children: <Widget>[
        ...
        _buildIsTypeSimulator(),
      ],
    );
  }

  Widget _buildMessage() => ListView.builder(
        itemCount: 25,
  ...
  Widget _buildIsTypeSimulator() => Container(
        color: Colors.grey,
...
class _TypingIndicatorState extends State<TypingIndicator>
  ...
  void didUpdateWidget(covariant TypingIndicator oldWidget) {
    ...
    debugPrint("didUpdateWidget showIndicator  ${widget.showIndicator}"
        " oldWidget showIndicator ${oldWidget.showIndicator}}");
  ...
  Widget _buildCircleBubble(double size) => Container(
        width: size,
        height: size,
        decoration: BoxDecoration(
  ...
  Widget _buildStatusBubble() => Container(
        width: 85,
        height: 44,
  ...
  Widget _buildFlashingCircle(int index) => AnimatedBuilder(
