...
class ExampleLayoutContraints extends StatefulWidget {
  const ExampleLayoutContraints({Key? key}) : super(key: key);

  @override
  State<ExampleLayoutContraints> createState() =>
      _ExampleLayoutContraintsState();
}

class _ExampleLayoutContraintsState extends State<ExampleLayoutContraints> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(),
      body: const FlutterLayoutArticle(
        examples: [
          Example1(),
          Example2(),
          Example3(),
...
class _FlutterLayoutArticleState extends State<FlutterLayoutArticle> {
  ...
  void initState() {
    super.initState();
    _example = widget.examples.first;
  }

  @override
  void didUpdateWidget(covariant FlutterLayoutArticle oldWidget) {
    super.didUpdateWidget(oldWidget);
    _example = widget.examples[_currentIndex];
  }
  ...
  Widget _buildButton(int index) => Button(
...
class Example3 extends Example {
  ...
  @override
  String get explanation => 'Center>Container(100*100)';
}
...
class Example4 extends Example {
  ...
  @override
  String get explanation => 'Align(bottomRight)>Container(100*100)';
}
